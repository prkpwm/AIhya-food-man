              ...
              children: [
                  ...
                  child: SizedBox(
                    ...
                    child: menu.imageUrl != null
                        ? Image.network(menu.imageUrl!, fit: BoxFit.cover,
                            errorBuilder: (_, __, ___) => const Center(child: Icon(Icons.restaurant, size: 40, color: Color(0xFFE0E0E0))))
                ...
                if (!menu.isAvailable)
                  Container(
                    ...
                    child: const Center(child: Text('หมด', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold))),
                  ),
                Positioned(
                  top: 8, right: 8,
                  child: Container(
